...
//         let bit_pubkeys: Vec<BggPublicKey<DCRTPolyMatrix>> =
...
//         let int_poly = DCRTPoly::from_const(&params, &FinRingElem::constant(&params.modulus(),
// 13));         let plaintexts = int_poly.decompose_bits(&params);
