...
//         let (inputs, scalar_inputs) = circuit.input(1, 0);
...
//         // Evaluate the circuit
//         let result =
//             circuit.eval(&params, &pk_one, &[pk1.clone(), pk2.clone(), pk3.clone(),
// pk4.clone()]);
...
//             .call_sub_circuit(middle_circuit_id, &[main_inputs[0], main_inputs[1],
// main_inputs[2]]);
