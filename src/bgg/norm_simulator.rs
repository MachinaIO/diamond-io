...
//     NormSimulator {
//         h_norm: self.h_norm.right_rotate(self.dim as u64 * (self.base as u64 - 1)) + &rhs.h_norm
// * &self.plaintext_norm,         plaintext_norm: &self.plaintext_norm * &rhs.plaintext_norm,
//         dim: self.dim,
//         base: self.base,
//     }
// });
